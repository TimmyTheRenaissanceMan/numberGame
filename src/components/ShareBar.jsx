    ...
    >
      ...
      <Col className="p-1" xs="2" style={{ maxWidth: "120px" }}>
        <Button
          ...
          size="sm"
          href={"https://twitter.com/intent/tweet?text=" + domain}
          target="_blank"
        >
      ...
      <Col className="p-1" xs="2" style={{ maxWidth: "120px" }}>
        <Button
          ...
          size="sm"
          href={"whatsapp://send?text=" + domain}
          target="_blank"
        >
      ...
      <Col className="p-1" xs="2" style={{ maxWidth: "120px" }}>
        <Button
          ...
          size="sm"
          href={"https://www.reddit.com/submit?url=" + domain}
          target="_blank"
        >
      ...
      <Col className="p-1" xs="2" style={{ maxWidth: "120px" }}>
        <Button
          ...
          size="sm"
          href={"mailto:?subject=&amp;&body=" + domain}
          target="_blank"
        >
