  ...
  return (
    <div className="mainColor">
      ...
      <Row className="text-start mx-auto" style={{ maxWidth: "1000px" }}>
        <p>
          At number-game, accessible from https://number-game-ten.vercel.app/,
          one of our main priorities is the privacy of our visitors. This
          Privacy Policy document contains types of information that is
          collected and recorded by number-game and how we use it. If you have
          ...
          number-game. This policy is not applicable to any information
        ...
        <h4>Log Files </h4>
        <p>
          number-game follows a standard procedure of using log files. These
        ...
        <p>
          ...
          advertising partners of number-game. Third-party ad servers or ad
          ...
          on number-game, which are sent directly to users' browser. They
          automatically receive your IP address when this occurs. These
          technologies are used to measure the effectiveness of their
          advertising campaigns and/or to personalize the advertising content
          that you see on websites that you visit. Note that number-game has no
          access to or control over these cookies that are used by third-party
          advertisers.
        </p>
        <h4>Third Party Privacy Policies</h4>
        <p>
          number-game's Privacy Policy does not apply to other advertisers or
        ...
        <p>
          ...
          number-game does not knowingly collect any Personal Identifiable
